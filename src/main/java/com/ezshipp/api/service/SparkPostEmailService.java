...
@Service
public class SparkPostEmailService {

//    private @Value("${sparkpost.apikey}") String apikey;
//    private @Value("${sparkpost.sender}") String senderEmail;
//    private @Value("${sparkpost.url}") String url;
//    private @Value("${sparkpost.recepients}") String recepientsList;

    private static String apikey = "907889aed76dde6a1207e1479d387c89b11badb3";
    private String senderEmail = "mail.ezshipp.com";
    private  String url = "https://api.sparkpost.com/api/v1";
    private  String recepientsList = "srinivas.seri@ezshipp.com";

    public static void main(String[] args) {
        SparkPostEmailService emailService = new SparkPostEmailService();
        try {
            emailService.runApp();
//            Client sparky = new Client(apikey);
//
//            sparky.sendMessage(
//                    "testing@sparkpostbox.com",
//                    "srinivas.seri@ezshipp.com",
//                    "Oh hey!",
...
//                    "<p>Testing SparkPost - the world's most awesomest email service!</p>");
    ...
    protected void runApp() throws Exception {
        ...
        String fromAddress = "srinivas.seri@ezshipp.com";
        String[] recipients =   recepientsList.split(",");
    ...
    protected Client newConfiguredClient() throws SparkPostException, IOException {
        ...
        client.setFromEmail(senderEmail);

        System.out.println(client.getFromEmail());
    ...
    private void sendEmail(String from, String[] recipients, String email) throws SparkPostException, IOException {
        ...
        substitutionData.put("name", "ezshipp");
        ...
        // Send the Email
        IRestConnection connection = new RestConnection(sparkpostClient, url);
